...
function Success() {
  const { id } = useSearch({ from: "/sell/quick/success" });
    ...
    <MobileFrame>
      <div className="min-h-dvh bg-background pb-28">
        <div className="gradient-brand px-6 pt-10 pb-8 text-center text-white">
          ...
          <h1 className="mt-3 text-xl font-extrabold">Your listing has been submitted</h1>
          <p className="mt-1 text-sm text-white/80">We're reviewing it to keep Omeetso safe and trustworthy.</p>
        </div>
        <div className="-mt-4 rounded-t-3xl bg-background p-4">
          {l ? (
            ...
            <div className="mb-4 rounded-2xl border border-dashed border-border bg-card p-4 text-center text-sm text-muted-foreground">
