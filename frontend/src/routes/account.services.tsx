...
export const Route = createFileRoute("/account/services")({
  component: CustomerServicesDashboardPage,
});

function CustomerServicesDashboardPage() {
                  ...
                  {inquiries.map((inq) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <div className="rounded-2xl bg-surface-2 p-3 text-xs text-muted-foreground leading-relaxed">
